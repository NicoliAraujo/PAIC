        ...
        for i in range(0, n):
            ...
            for j in range(0, m):
                if(j == 0):
                    ...
                    k = int(input("Valor "+str(j)+": "))
                    l.append(k)
            self.setInput(l)
        print("Saidas")
        for i in range(0, n):
            self.setOutput(int(input("Saida "+str(i)+": ")))
        print("Pesos")
        for i in range(0, m):
            self.setWeigth(float(input("Peso "+str(i)+": ")))
        self.setLearningRate(float(input("Taxa de aprendizado: ")))
        self.setLimit(float(input("Limite entre as classes: ")))
